      ...
      {showPopup && (
        ...
        >
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${regionStyling.gradientFrom} ${regionStyling.gradientTo} opacity-60`}
            />
            ...
            <div className="relative z-20 p-6 text-center">
              ...
              >
                <div className="relative w-24 h-24 mx-auto mb-4">
                  ...
                  <div className="absolute -bottom-2 -right-2">
                    <RankBadgeEffects points={playerPoints} size="lg" animated={true} />
                  </div>
                </div>
                ...
                >
                  ...
                  <h3 className="text-2xl font-black text-white uppercase tracking-wider">{popupData.player.ign}</h3>
                </motion.div>
              ...
              >
                <h4 className="text-slate-400 text-xs uppercase tracking-widest mb-4 font-bold">🏆 COMBAT POSITION</h4>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}>
                <h4 className="text-slate-400 text-xs uppercase tracking-widest mb-4 font-bold">⚔️ GAMEMODE TIERS</h4>
